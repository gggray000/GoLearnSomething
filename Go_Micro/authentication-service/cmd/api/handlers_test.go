...
func NewTestCleint(fn RoundTripFunc) *http.Client {
	return &http.Client{
		Transport: fn,
	}
}
...
`
	client := NewTestCleint(func(req *http.Request) *http.Response {
		return &http.Response{
			StatusCode: http.StatusOK,
			Body:       io.NopCloser(bytes.NewBufferString(jsonToReutrn)),
