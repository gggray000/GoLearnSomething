...
func (c *TripConsumer) Listen() error {
	return c.rabbitmq.ConsumeMessages(messaging.PaymentTripRequestQueue, func(ctx context.Context, msg amqp091.Delivery) error {
		...
		var payload messaging.PaymentTripRequestData
...
func (c *TripConsumer) handleTripAccepted(ctx context.Context, payload messaging.PaymentTripRequestData) error {
